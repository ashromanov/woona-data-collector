...
class BatchingPacketCaptureController(
    ...
    ): PacketSubmitResult = delegate.submit(packetFragment, receivedAtMillis, receivedAtMonotonicNs)
    ...
    override fun currentPacketTimelineFile() = delegate.currentPacketTimelineFile()
